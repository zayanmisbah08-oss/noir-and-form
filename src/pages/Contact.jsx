...
export default function Contact() {
  ...
  const inputStyle = (field) => ({
    ...
    padding: isMobile ? '14px 18px' : '17px 24px',
  ...
  return (
    <div style={{ background: '#000000' }}>
      ...
      <section style={{
        ...
        paddingTop: navH, overflow: 'hidden',
      }}>
        {/* Particle field */}
        ...
        <div style={{
          ...
          textAlign: 'center',
          maxWidth: 880,
          padding: isMobile ? `40px ${hPad} 56px` : `0 ${hPad}`,
          width: '100%',
        }}>
          <motion.p
            initial={{ opacity: 0 }} animate={{ opacity: 1 }}
            transition={{ duration: 0.7, delay: 0.2 }}
            style={{ fontFamily: 'var(--font-body)', fontSize: 11, letterSpacing: '0.18em', textTransform: 'uppercase', color: 'rgba(255,255,255,0.25)', marginBottom: isMobile ? 28 : 40 }}
          >
          ...
          <motion.h1
            ...
            style={{
              ...
              fontSize: isMobile ? 'clamp(44px, 14vw, 80px)' : 'clamp(52px, 8vw, 124px)',
              lineHeight: 0.96, letterSpacing: '-0.045em', color: '#ffffff',
              margin: `0 0 ${isMobile ? '40px' : '64px'}`,
            }}
          >
          ...
          {!sent ? (
            <motion.form
              ...
              style={{ display: 'flex', flexDirection: 'column', gap: 12, maxWidth: 520, margin: '0 auto' }}
            >
              <input
            ...
            >
              <p style={{ fontFamily: 'var(--font-albra)', fontSize: 22, color: '#ffffff', lineHeight: 1.3, margin: 0 }}>
          ...
          <motion.p
            ...
            style={{ fontFamily: 'var(--font-body)', fontSize: 13, color: 'rgba(255,255,255,0.25)', marginTop: 24 }}
          >
      ...
      {/* ── OFFICE LOCATIONS ── */}
      <section style={{ background: '#0a0a0c', borderTop: '1px solid rgba(255,255,255,0.06)', padding: `${isMobile ? '56px' : '72px'} ${hPad} ${isMobile ? '64px' : '80px'}` }}>
        <div style={{ maxWidth: 'var(--page-max-width)', margin: '0 auto' }}>
          <p style={{ fontFamily: 'var(--font-body)', fontSize: 11, letterSpacing: '0.18em', textTransform: 'uppercase', color: 'rgba(255,255,255,0.22)', marginBottom: isMobile ? 36 : 48 }}>
            Our offices
          </p>
          <div style={{
            display: 'grid',
            ...
            {OFFICES.map((o, i) => (
              ...
              >
                <p style={{ fontFamily: 'var(--font-body)', fontSize: 11, letterSpacing: '0.14em', textTransform: 'uppercase', color: 'rgba(255,255,255,0.28)', marginBottom: 14 }}>
                  {o.city}
                </p>
                <p style={{ fontFamily: 'var(--font-body)', fontSize: 15, lineHeight: 1.65, color: 'rgba(255,255,255,0.52)', margin: '0 0 12px', whiteSpace: 'pre-line' }}>
                  {o.addr}
                </p>
